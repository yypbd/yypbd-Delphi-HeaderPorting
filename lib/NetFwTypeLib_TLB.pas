...
// $Rev: 45604 $
// File generated on 2012-10-09 오후 4:14:43 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Windows\SysWOW64\FirewallAPI.dll (1)
...
const
  ...
  IID_INetFwRule2: TGUID = '{9C27C8DA-189B-4DDE-89F7-8B39A316782C}';
  ...
  IID_INetFwProduct: TGUID = '{71881699-18F4-458B-B892-3FFCE5E07F75}';
  IID_INetFwProducts: TGUID = '{39EB36E0-2097-40BD-8AF2-63A13B525362}';
...
// *********************************************************************//
  ...
  INetFwProductDisp = dispinterface;
  INetFwProducts = interface;
  INetFwProductsDisp = dispinterface;
...
// *********************************************************************//
  INetFwRule2 = interface(INetFwRule)
    ['{9C27C8DA-189B-4DDE-89F7-8B39A316782C}']
    function Get_EdgeTraversalOptions: Integer; safecall;
    procedure Set_EdgeTraversalOptions(lOptions: Integer); safecall;
    property EdgeTraversalOptions: Integer read Get_EdgeTraversalOptions write Set_EdgeTraversalOptions;
  end;

// *********************************************************************//
// DispIntf:  INetFwRule2Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {9C27C8DA-189B-4DDE-89F7-8B39A316782C}
// *********************************************************************//
  INetFwRule2Disp = dispinterface
    ['{9C27C8DA-189B-4DDE-89F7-8B39A316782C}']
    property EdgeTraversalOptions: Integer dispid 19;
    property Name: WideString dispid 1;
    property Description: WideString dispid 2;
    property ApplicationName: WideString dispid 3;
    property serviceName: WideString dispid 4;
...
// *********************************************************************//
  INetFwProduct = interface(IDispatch)
    ['{71881699-18F4-458B-B892-3FFCE5E07F75}']
    function Get_RuleCategories: OleVariant; safecall;
    procedure Set_RuleCategories(RuleCategories: OleVariant); safecall;
    function Get_DisplayName: WideString; safecall;
    procedure Set_DisplayName(const DisplayName: WideString); safecall;
    function Get_PathToSignedProductExe: WideString; safecall;
    property RuleCategories: OleVariant read Get_RuleCategories write Set_RuleCategories;
    property DisplayName: WideString read Get_DisplayName write Set_DisplayName;
    property PathToSignedProductExe: WideString read Get_PathToSignedProductExe;
  end;

// *********************************************************************//
// DispIntf:  INetFwProductDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {71881699-18F4-458B-B892-3FFCE5E07F75}
// *********************************************************************//
  INetFwProductDisp = dispinterface
    ['{71881699-18F4-458B-B892-3FFCE5E07F75}']
    property RuleCategories: OleVariant dispid 1;
    property DisplayName: WideString dispid 2;
    property PathToSignedProductExe: WideString readonly dispid 3;
  end;
...
// *********************************************************************//
  INetFwProducts = interface(IDispatch)
    ['{39EB36E0-2097-40BD-8AF2-63A13B525362}']
    function Get_Count: Integer; safecall;
    function Register(const product: INetFwProduct): IUnknown; safecall;
    function Item(index: Integer): INetFwProduct; safecall;
    function Get__NewEnum: IUnknown; safecall;
    property Count: Integer read Get_Count;
    property _NewEnum: IUnknown read Get__NewEnum;
  end;
...
// *********************************************************************//
  INetFwProductsDisp = dispinterface
    ['{39EB36E0-2097-40BD-8AF2-63A13B525362}']
    property Count: Integer readonly dispid 1;
    function Register(const product: INetFwProduct): IUnknown; dispid 2;
    function Item(index: Integer): INetFwProduct; dispid 3;
    property _NewEnum: IUnknown readonly dispid -4;
  end;
